...
<script src="{{asset('/control/assets/global/plugins/bootstrap-contextmenu/bootstrap-contextmenu.js')}}" type="text/javascript"></script>
...
<script src="{{asset('/control/assets/pages/scripts/components-context-menu.min.js')}}" type="text/javascript"></script>
